...
*/
  ...
  $sql = "SELECT DISTINCT membres.EMAIL,membres.ID_MEMBRE,membres.NOM, membres.PRENOM, rdv.* FROM membres, rdv WHERE rdv.ID_MEMBRE = membres.ID_MEMBRE AND rdv.STATUT = 'Annules' ORDER BY rdv.DATE ASC";
        ...
        echo  '<div class="card">';
            ...
            echo '<form method="POST" action="modif.php">';
                ...
                echo '</div>';
                 ...
                 echo '<div class="form-group">';
                 echo '<label for="Debut">Heure Debut</label>';
