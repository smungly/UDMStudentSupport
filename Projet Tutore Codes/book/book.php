...
function maFonc(){
  alert("Votre demande de rdv est validee, veuillez consulter vos mails pour toute evolution.");
  location.reload(); 
};
...
<p>&nbsp;&nbsp;</p>
<h3 style="text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="../main.php"><img src="../images/back.png"><a/>&nbsp;&nbsp;&nbsp;&nbsp;RETOUR</h3>

<section style="padding-top: 20px;">
</section>

<div class="container">
      <h2>Prendre un rendez-vous avec la conseillère d'orientation <img src="../images/new_appoint.png"></h2>
    <h4>Informations sur les dates disponible et non disponible.</h4>
    <br>
<div class="row">
<div class="col">
<div style="float: left;width: 18rem;height: 30rem;padding-bottom: 10px" class="card">
  <div style="background-color: #eaeaea" class="card-body">
  	...
  	<form>
        ...
        <input type="hidden" class="form-control" id="id" value="<?php echo $idmembre; ?>">
            ...
            <small class="form-text text-muted"><i>*Voir si date disponible sur le calendrier à côté.</i></small>
          </div>
        ...
        <div class="form-group">
          ...
          <small class="form-text text-muted"><i>*Les horaires pour une date qui ne sont pas libres sont marquées en rouge sur le calendrier à côté.</i></small>
  			</div>
      ...
      <div class="form-group">
           ...
           <small id="desc" class="form-text text-muted"><i>*Donnez une description brève de vos attentes par rapport au rendez-vous.</i></small>
  			</div>
...
$(document).ready(function() {
  ...
  var calendar = $('#calendar').fullCalendar({
    ...
    eventRender: function (event, element, view) {
      if(event.title == 'Reservé/Indisponible'){
          element.css('background-color', '#9bcebb')
      }
    },
   });
  });
